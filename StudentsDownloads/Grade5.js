const Grade5 = [
    ...
    // Add more resources for Grade 5 here
];
...
Grade5.forEach(student => {
    student.age = calculateAge(student.date);
});

// Exporting the updated Grade5 array
export default Grade5;

console.log(Grade5); // For debugging purposes to see the updated array
